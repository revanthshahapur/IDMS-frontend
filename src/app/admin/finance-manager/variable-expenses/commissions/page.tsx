...
export default function AdminCommissionsPage() {
    ...
    const fetchExpenses = async () => {
        try {
            ...
            toast.error('Failed to fetch commission expenses');
            setExpenses([]);
        } finally {
            setLoading(false);
        }
    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-transparent flex items-center justify-center">
                <div className="text-lg text-gray-600">Loading commission expenses...</div>
            </div>
        );
    }
                ...
                <div className="bg-gradient-to-br from-white via-blue-50 to-indigo-50 dark:from-gray-800 dark:via-slate-800 dark:to-indigo-900 shadow-xl border-b border-blue-200 dark:border-indigo-700 rounded-2xl p-6">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                <h1 className="text-3xl font-bold bg-gradient-to-r from-amber-600 to-yellow-600 bg-clip-text text-transparent">Sales Commissions</h1>
                                <p className="text-base text-gray-600 dark:text-gray-300 mt-1">View sales commission and bonus records</p>
                            </div>
                        </div>
                        <div className="mt-4 md:mt-0 text-center md:text-right">
                            <div className="text-2xl font-bold text-amber-600 dark:text-amber-400">{expenses.length}</div>
                ...
                <div className="mt-8 bg-gradient-to-br from-white via-blue-50/30 to-indigo-50/30 dark:from-gray-800 dark:via-slate-800/50 dark:to-indigo-900/30 rounded-2xl shadow-2xl border border-blue-200/50 dark:border-indigo-700/50 backdrop-blur-sm">
                    <div className="px-8 py-6 border-b border-blue-200/50 dark:border-indigo-700/50 bg-gradient-to-r from-blue-50/50 to-indigo-50/50 dark:from-slate-800/50 dark:to-indigo-900/50 rounded-t-2xl">
                        <h2 className="text-xl font-bold text-gray-900 dark:text-white flex items-center gap-3">
                            ...
                            <span className="bg-gradient-to-r from-amber-600 to-yellow-600 bg-clip-text text-transparent">Sales Commissions</span>
                            <span className="ml-2 px-3 py-1 bg-gradient-to-r from-amber-100 to-yellow-100 dark:from-amber-900/50 dark:to-yellow-900/50 text-amber-700 dark:text-amber-300 text-sm font-semibold rounded-full hidden sm:inline-block">
                                {expenses.length}
                            </span>
                        </h2>
                    </div>
                                    ...
                                    <tr>
                                        <td colSpan={9} className="px-6 py-12 text-center">
                                            <div className="text-gray-500 dark:text-gray-400">
                                                ...
                                                <p className="text-lg font-medium">No commission expenses found</p>
                    ...
                    <div className="sm:hidden p-4 space-y-4">
                        {expenses.length > 0 ? (
                                    ...
                                    <div className="mt-3">
                                        {expense.documentPath ? (
                                            <button
                                                ...
                                                className="inline-flex items-center text-amber-600 hover:text-amber-800 underline text-sm"
                                            >
                                                📄 View Document
                                            </button>
                                        ) : (
                            ...
                            <div className="text-center py-12">
                                <span className="text-6xl mb-4 block">💰</span>
                                <p className="text-lg font-medium text-gray-500">No commission expenses found</p>
